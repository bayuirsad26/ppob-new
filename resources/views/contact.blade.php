        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="banner_content" data-aos="fade-up">
                    <div class="box">
                        <span class="mb-0">Home</span><figure class="mb-0"><img src="./assets/images/subbanner_arrow.png" alt="" class="img-fluid"></figure><span class="mb-0 box_span">Contact</span>
                    </div>
                    <h1>Contact Us</h1>
                    <p class="mb-0 text-white">Get in touch with us today! Whether you have questions, feedback, or inquiries, our team is here to assist you.</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="feature_aboutcontent box hover1">
                        <div class="icon-size1">
                            <figure class="mb-0 contact-addressicon">
                                <img src="./assets/images/contact-addressicon.png" alt="" class="img-fluid">
                            </figure>
                        </div>
                        <h5>Address</h5>
                        <p class="mb-0 text-size-18">121 King Street, Melbourne Victoria 3000 Australia</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="feature_aboutcontent box hover2">
                        ...
                        <h5>Phone</h5>
                        <a href="tel:+61383766284" class="mb-0 text-decoration-none text-size-18">+61 3 8376 6284</a>
                        <a href="tel:+80023456789" class="mb-0 text-decoration-none text-size-18">+800 2345 6789</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="feature_aboutcontent box hover3">
                        ...
                        <h5>Email</h5>
                        <a href="mailto:info@apprista.com" class="mb-0 text-decoration-none text-size-18">info@apprista.com</a>
                        <a href="mailto:support@apprista.com" class="mb-0 text-decoration-none text-size-18">support@apprista.com</a>
                    </div>
                </div>
            </div>
        </div>
